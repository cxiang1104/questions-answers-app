Public Class AnswersForm
    ...
    Private Sub LoadAnswersToolStripMenuItem_Click(sender As Object, e As EventArgs)
        LoadAnswers()
    End Sub
    Private Sub AnswerForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadAnswers()
    End Sub
End Class